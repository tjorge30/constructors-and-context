...
console.log(CarFactory('Honda', 'Civic'))
////////// PROBLEM 2 //////////
...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  function Car(make, model, year) {
    ...
    this.model = model;
    this.year = year;
    //Increments move property by 10. Returns the new move property.
 ...
 User.prototype.addSavedPost = function(id, title, rating) {
  ...
  User.prototype.removeSavedPost = function(postId){
    var updatedPosts = this.savedPosts;
    updatedPosts.splice(this.savedPosts.findIndex( x => x.id === postId), 1)
  ...
  //the savedPosts array. Once you find the matching object, update it's rating score 
  //with the new rating parameter.
  
  // Code here
  User.prototype.changePostRating = function(id, newRating){
    var item = this.savedPosts.findIndex( x => x.id === id);
    this.savedPosts[item].rating = newRating;
  }